...
class PresetForm extends React.Component {
  ...
  onValidate(e) {
    ...
    // Validate data
    try {
      if (!data.name) throw 'Preset must have a name';
      if (data.name.length > 100) throw 'Preset name limited to 100 characters';
      if (!data.urlMatch) throw 'URL match does not exist';
